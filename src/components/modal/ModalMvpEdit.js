...
export default function ModalMvpEdit({postId}) {
         ...
         <div className="modal___button">
                ...
                <button type="button" className="modal_Button" onClick={handleClose}>Back</button>
                   <button type="button" className="modal_Button" onClick={()=>{
                      dispatch(mvp(user._id,postId,title,link))
                       setTitle("")
                       setLink("")
                       setOpen(false)
                   }}>Post</button>
  ...
  return (
    <div>
      ...
      <Button variant='outlined' style={{borderRadius:"20px"}} onClick={handleOpen} color="primary">update</Button>
      <Modal
        open={open}
